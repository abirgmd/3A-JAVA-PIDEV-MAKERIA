...
public class ProduitController implements Initializable {
    ...
    @FXML
    void showMessage(ActionEvent event) {loadUI("AfficherMessageAdmin.fxml");
    }
    @FXML
    void showReply(ActionEvent event) {loadUI("AfficherReplyAdmin.fxml");
    }
    @FXML
    ...
    @FXML
    void setReponse(ActionEvent event) {loadUI("afficher-reclamation.fxml");}
