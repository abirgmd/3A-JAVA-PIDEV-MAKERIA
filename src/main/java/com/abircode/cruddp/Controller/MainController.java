...
public class MainController {
    ...
    @FXML private StackPane cartIconPane;
    ...
    public void initialize() {
        ...
        setupEventHandlers();
        setupMenuItems();
        // Met à jour le badge au lancement
        updateCartBadge(CartService.getInstance().getCartItems().size());

        // Injecte ce controller dans CartService
        CartService.getInstance().setMainController(this);
    ...
    private void setupMenuItems() {
        ...
        if (forumMenu != null) {
            ...
            myForum.setOnAction(event -> {
                loadContent("/Fxml/AfficherMessage.fxml");
            });
