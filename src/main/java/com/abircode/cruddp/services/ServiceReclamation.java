...
public class ServiceReclamation implements IService<Reclamation> {
    ...
    public List<Reclamation> afficher() throws SQLException {
        ...
        while (rs.next()) {
            ...
            r.setUser(us.getUserById(rs.getInt("id_utilisateur")));
    ...
    public Map<StatutReclamation,Long> getStatutReclamationCount() throws SQLException {
        List<Reclamation> reclamations = afficher();
        return reclamations.stream().collect(Collectors.groupingBy(Reclamation::getStatRec, Collectors.counting()));
    }
